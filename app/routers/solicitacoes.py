...
from app.models.solicitacao_laboratorio import SolicitacaoLaboratorio, SolicitacaoLaboratorioItem, SolicitacaoStatusHistorico
from app.schemas.solicitacao_laboratorio import SolicitacaoLaboratorioCreate, SolicitacaoLaboratorioOut
