...
from app.models.solicitacao_laboratorio import SolicitacaoLaboratorio, SolicitacaoLaboratorioItem, SolicitacaoLaboratorioStatusHistorico
...
def criar_solicitacao(solicitacao: SolicitacaoLaboratorioCreate, db: Session = Depends(get_db), usuario: Usuario = Depends(get_current_user)):
