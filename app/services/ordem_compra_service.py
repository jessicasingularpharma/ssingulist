...
from app.models.ordem_compra import (
    OrdemCompra, OrdemCompraDetalhes, PendenciaSubstancia, FranquiaOrdem,
    OrdemCompraDetalhesCreate, PendenciaSubstanciaCreate, FranquiaOrdemCreate,
    OrdemCompraStatusHistorico, StatusOrdemCompra
)
...
def atualizar_status_ordem_com_historico(db: Session, ordem_id: int, novo_status: OrdemCompraStatusUpdate, usuario: Usuario):
...
def registrar_status_historico(db: Session, ordem_id: int, novo_status: StatusOrdemCompra, usuario_id: int):
...
def criar_detalhes_ordem(db: Session, detalhes_data: OrdemCompraDetalhesCreate) -> OrdemCompraDetalhes:
...
def atualizar_detalhes_ordem(db: Session, ordem_id: int, novos_dados: dict) -> OrdemCompraDetalhes:
...
def adicionar_pendencia_substancia(db: Session, pendencia_data: PendenciaSubstanciaCreate) -> PendenciaSubstancia:
...
# --- Franquias ---
def adicionar_franquia_ordem(db: Session, franquia_data: FranquiaOrdemCreate) -> FranquiaOrdem:
